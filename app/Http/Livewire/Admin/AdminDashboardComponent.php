...
class AdminDashboardComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view(
            ...
            ['totalServiceProvider' => $totalServiceProvider, 'totalUser' => $totalUser, 'totalServiceCategories' => $totalServiceCategories, 'total' => $total, 'sproviders' => $sproviders, 'contacts' => $contacts, 'users' => $users])->layout('frontend.layouts.guest');
    }
}
